...
# Welcome message
echo "=================================================="
echo "             Welcome to Sharathchandra's Script!             "
echo "=================================================="
echo "You are now using my personal DevOps setup script!"
echo
echo "This script will assist you in installing essential packages for Jenkins and Docker."
echo "For any questions or feedback, feel free to reach out to me directly!"
echo
echo "I have designed this script to simplify the installation process and make your setup smoother."
echo "=================================================="
echo
